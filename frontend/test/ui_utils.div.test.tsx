...
describe('div, css', () => {
  test('strings', async () => {
    ...
    expect(el.container.innerHTML).toMatchInlineSnapshot(str`<div class="sc-AxjAm StDqN">hello</div>`)
  })

  test('elements', async () => {
    const el = render(div(<b>X</b>, <i>Y</i>))
    expect(el.container.innerHTML).toMatchInlineSnapshot(str`<div class="sc-AxjAm StDqN"><b>X</b><i>Y</i></div>`)
  })
  ...
  test('nested', async () => {
    ...
    expect(el.container.innerHTML).toMatchInlineSnapshot(str`<div class="sc-AxjAm StDqN">hell<i>o</i>!</div>`)
  })

  test('className', async () => {
    const el = render(div({className: "bepa"}, {className: "cepa"}))
    expect(el.container.innerHTML).toMatchInlineSnapshot(str`<div class="sc-AxjAm StDqN bepa cepa"></div>`)
  })
  ...
  test('styles', async () => {
    ...
    expect(el.container.innerHTML).toMatchInlineSnapshot(str`<div style="color: blue; background: green;" class="sc-AxjAm StDqN"></div>`)
  })
  ...
  test('onClicks', async () => {
    ...
    expect(el.container.innerHTML).toMatchInlineSnapshot(str`<div class="sc-AxjAm StDqN">hit me</div>`)
  })
})
